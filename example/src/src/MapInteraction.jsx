...
export class MapInteractionControlled extends Component {
  ...
  static get propTypes() {
    return {
      ...
      value: PropTypes.shape({
        ...
        gestureStartRotation: PropTypes.number,
        gestureStartScale: PropTypes.number,
  ...
  */
  ...
  // MY CODE START
    ...
    onGestureStart (e) {
    e.preventDefault();
    this.props.value.startX = e.pageX - this.props.value.posX;
    this.props.value.startY = e.pageY - this.props.value.posY;
    this.props.value.gestureStartRotation = this.props.value.rotation;
    this.props.value.gestureStartScale = this.props.value.myScale;
  ...
  onGestureChange (e) {
    ...
    this.props.value.rotation = this.props.value.gestureStartRotation + e.rotation;
    this.props.value.myScale = this.props.value.gestureStartScale * e.myScale;

    this.props.value.posX = e.pageX - this.props.value.startX;
    this.props.value.posY = e.pageY - this.props.value.startY;
    
    var val = `translate3D(${this.props.value.posX}px, ${this.props.value.posY}px, 0px) rotate(${this.props.value.rotation}deg) scale(${this.props.value.myScale})`;
    this.props.value.node.style.transform = val;
  }
  ...
  if (e.ctrlKey) {
    this.props.value.myScale -= e.deltaY * 0.01;
  } else {
    this.props.value.posX -= e.deltaX * 2;
    this.props.value.posY -= e.deltaY * 2;
  }

    const newScale = clamp(
      this.props.minScale,
      this.props.value.myScale,
      this.props.maxScale
    );

    const mousePos = this.clientPosToTranslatedPos({ x: this.props.value.posX, y: this.props.value.posY });
